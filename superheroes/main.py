...
nombre = InputUntil('Introduce tu nombre, por favor: ', lambda s: s.isalnum() and len(s) > 0)
apellido = InputUntil('Introduce tu primer apellido, por favor: ', lambda s: s.isalnum() and len(s) > 0)
